...
class Admin extends CI_Controller {
	...
	public function postEmployeePerformance(){
		...
		$this->am->uploadEmployeeCommunication($communication_data);
		...
		$this->am->uploadEmployeeProductivity($productivity_data);
		...
		$this->am->uploadEmployeeQuality($quality_data);
		...
		$this->am->uploadEmployeeKnowledge($knowledge_data);
		...
		$this->am->uploadEmployeeSoftware($software_data);
		...
		$this->am->uploadEmployeeDependability($dependability_data);
		...
		$this->am->uploadEmployeeTimeManagement($time_management_data);
		...
		$this->am->uploadEmployeeAdaptability($adaptability_data);
		...
		$this->am->uploadEmployeeInitiativeProactive($initiative_proactive_data);
		...
		$this->am->uploadEmployeeCreativityProblemSolving($creativity_problem_solving_data);
